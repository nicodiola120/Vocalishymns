...
$bundleId = "Vocalishymns-$version-$timestamp"
...
$manifest = @"
{
  "version": "$version",
  "bundleId": "$bundleId",
  "bundleUrl": "https://nicodiola120.github.io/Vocalishymns/$zipName",
...
$tempDir = Join-Path $env:TEMP "Vocalishymns-ghpages-deploy"
if (Test-Path $tempDir) { Remove-Item $tempDir -Recurse -Force }

# Clone the existing gh-pages branch
git clone --branch gh-pages "https://github.com/nicodiola120/Vocalishymns.git" $tempDir
...
git config user.email "domz@Vocalishymns.app"
...
Write-Host "  Bundle:   https://nicodiola120.github.io/Vocalishymns/$zipName"
Write-Host "  Manifest: https://nicodiola120.github.io/Vocalishymns/version.json"
